 ...
 <div class="container-fluid">
 	<ul class="list-unstyled list-inline">
	 	<li>
	 		<div>
		 		<br>
				<h3 class="pmd-card-title-text">&copy; <span class="auto-update-year"></span>, made by F4nt4stic</h3>
...
<script type="text/javascript" language="javascript" src="<?php echo base_url();?>assets/js/moment-with-locales.js"></script>
<script type="text/javascript" language="javascript" src="<?php echo base_url();?>assets/js/bootstrap-datetimepicker.js"></script>
