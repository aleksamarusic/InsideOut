		...
		<div class="container-fluid full-width-container">
			<div class="row">
				<div class="col-lg-6 col-lg-offset-3">
					<button class="btn pmd-btn-raised btn-success btn-block pmd-ripple-effect btn-success" type="button" data-target="#give-task-modal"
							...
							<tbody>
								<tr>
									...
									<td class="td-actions text-right">
										<button class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-primary btn-xs" type="button" style="display: block;" data-target="#info-open-task-modal"
										 data-toggle="modal">
											<i class="material-icons pmd-xs">info</i>
										</button>
							...
							<tbody>
								<tr>
									...
									<td class="td-actions text-right">
										...
										<button class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-primary btn-xs" type="button" style="display: block;" data-target="#info-in-progress-task-modal"
										 data-toggle="modal">
											<i class="material-icons pmd-xs">info</i>
										</button>
						...
						<table id="example-checkbox" class="table pmd-table table-hover table-striped display responsive nowrap">
							...
							<tbody>
								<tr>
									<td>Sign contract for "What are conference organizers afraid of?"</td>
									<td class="td-actions text-right">
										<button class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-primary btn-xs" type="button" style="display: block;" data-target="#info-done-task-modal"
										 data-toggle="modal">
											<i class="material-icons pmd-xs">info</i>
										</button>
									</td>
